...
/**
  ...
  * included in the package <code>agenda2</code>.
  */
public class TestingAgenda2
{
    ...
    private static void removeExistingContact(Agenda agenda)
    {
        ...
        agenda.remove(new Contact(lastname, name, "", "", new etsinf.prg.agenda2.Date(day, month, year)));
    }

...
public class QueueIntArray2
{
    ...
    {
        if (o instanceof QueueIntArray2) {
            QueueIntArray2 other = (QueueIntArray2)o;
     ...
     */
    @Override
    public QueueIntArray2 clone()
    {
        QueueIntArray2 newQueue = new QueueIntArray2(buffer.length);

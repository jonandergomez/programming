...
public class FinalGrade
{
    ...
    public static void main(String [] args)
    {
        ...
        double fg = finalGrade(mg1, mg2, lg1, lg2);
    ...
    static double finalGrade(double mg1, double mg2, double lg1, double lg2)
    {
        /*
        ...
        */
        ...
        double mwg = 0.4 * mg1 + 0.6 * mg2;
        double lwg = 0.4 * lg1 + 0.6 * lg2;

        return 0.75 * mwg + 0.25 * lwg;
        //return 0.75 * (0.4 * mg1 + 0.6 * mg2) + 0.25 * (0.4 * lg1 + 0.6 * lg2);
    }
}

...
public class TestAgenda
{
    ...
    public static Agenda loadFromBinaryFile()
    {
        ...
        try {
            ...
            catch( IOException ioe ) { System.err.println( "ERROR trying to close file! " + ioe.getMessage() ); }
        }
    ...
    public static void saveToBinaryFile( Agenda agenda )
    {
        ...
        catch( IOException ioe ) { System.err.println( "ERROR trying to save the agenda into a file! " + ioe.getMessage() ); }
        finally {
            try {
